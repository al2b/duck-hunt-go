...
var (
	...
	cinematicDogMock = engine.Cinematic3D{
		{engine.Vec3D(114, 154, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 153, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 153, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 152, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 151, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 150, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 149, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 149, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 148, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 147, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 146, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 145, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 145, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 144, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 143, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 142, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 141, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 141, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 140, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 139, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 138, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 137, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 137, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 136, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 135, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 134, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 133, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 133, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 132, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 131, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 130, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 129, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 129, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 128, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 127, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 126, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 125, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 125, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 124, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 123, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 122, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 121, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 121, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 120, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 119, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 118, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock1, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock2, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock1, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock2, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock1, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock2, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock1, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock2, 5 * frameDuration},
		{engine.Vec3D(114, 117, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 119, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 121, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 123, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 125, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 125, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 127, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 129, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 131, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 133, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 133, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 135, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 137, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 139, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 141, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 141, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 143, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 145, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 147, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 149, 10), imageDogMock2, 1 * frameDuration},
		{engine.Vec3D(114, 149, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 151, 10), imageDogMock1, 1 * frameDuration},
		{engine.Vec3D(114, 153, 10), imageDogMock1, 1 * frameDuration},
	}
	cinematicDogRetrieve1 = engine.Cinematic3D{
		{engine.Vec3D(92, 155, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 153, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 151, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 149, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 147, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 145, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 143, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 141, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 139, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 137, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 135, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 133, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 131, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 129, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 127, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 125, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 123, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 121, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 119, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 117, 10), imageDogRetrieve1, 19 * frameDuration},
		{engine.Vec3D(92, 119, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 121, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 123, 10), imageDogRetrieve1, 1 * frameDuration},
		{engine.Vec3D(92, 125, 10), imageDogRetrieve1, 1 * frameDuration},
	...
	cinematicDogRetrieve2 = engine.Cinematic3D{
		{engine.Vec3D(92, 155, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 153, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 151, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 149, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 147, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 145, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 143, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 141, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 139, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 137, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 135, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 133, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 131, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 129, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 127, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 125, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 123, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 121, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 119, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 117, 10), imageDogRetrieve2, 19 * frameDuration},
		{engine.Vec3D(92, 119, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 121, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 123, 10), imageDogRetrieve2, 1 * frameDuration},
		{engine.Vec3D(92, 125, 10), imageDogRetrieve2, 1 * frameDuration},
